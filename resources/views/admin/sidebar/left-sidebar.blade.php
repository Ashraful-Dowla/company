        ...
        <div class="sidebar-scrollbar">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                <li class="has-sub {{ request()->is('admin*') ? '' : 'active expand'  }}">
                    ...
                    <ul class="collapse {{ request()->is('admin*') ? '' : ' show'  }}" id="dashboard" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            <li class="active">
                ...
                <li class="has-sub {{ request()->is('admin*') ? 'active expand' : '' }}">
                    ...
                    <ul class="collapse {{ request()->is('admin*') ? 'show' : ''  }}" id="ui-elements" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            <li class="active">
